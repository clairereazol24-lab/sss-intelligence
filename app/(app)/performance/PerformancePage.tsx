    ...
    <table className="text-sm table-fixed">
      <thead className="sticky top-0 z-10">
        <tr className="bg-gray-50 dark:bg-gray-700 text-center">
          ...
          <th className="px-2 py-2 text-gray-500 dark:text-gray-400 font-medium w-56">Store</th>
    ...
    <table className="text-sm table-fixed">
      <thead className="sticky top-0 z-10">
        <tr className="bg-gray-50 dark:bg-gray-700 text-center">
          ...
          <th className="px-3 py-2.5 text-gray-500 dark:text-gray-400 font-medium w-56">Store</th>
