...
export default function ProfileModal({ onClose }: Props) {
  ...
  const inputCls = 'w-full border border-gray-200 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100 rounded-lg px-3 py-2 text-sm mb-2 placeholder:text-gray-400 dark:placeholder:text-gray-500'
